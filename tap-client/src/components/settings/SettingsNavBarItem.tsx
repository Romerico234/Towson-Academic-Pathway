    ...
    return (
        <div className="flex flex-row  items-start space-x-5 ">
            <div
                ...
                className={
                    currentTab === name
                        ? "flex justify-center items-center  text-black w-36 h-10 bg-gray-400 bg-opacity-10 cursor-pointer rounded	"
                        : "flex justify-center items-center w-36 h-10 cursor-pointer text-stone-500 "
                }
            >
                {name}
            </div>
